...
{
    /// <summary>
    /// Static class to get CRC64 hash
    /// You can get CRC64 hash from byte array input data or input string data
    ...
    public static class CRC64
    {
        #region Properties
        // Predefined table
        private static ulong[] CRC64_Table =
        {
        ...
        #region Methods
        /// <summary>
        /// Get CRC64 hash from byte array input data
        /// </summary>
        /// <param name="data">Data to get hash from.</param>
        /// <returns>ULong with CRC64 hash from input data</returns>
        public static ulong Hash(byte[] data)
        {
            ulong crc = 0xffffffffffffffff;
            // For each byte of input data, do magic :)
            for (var pos = 0; pos < data.Length; pos++)
            {
                crc = CRC64_Table[((uint)(crc >> 56) ^ data[pos]) & 0xFF] ^ (crc << 8);
            }

            return ~crc;
        }
        /// <summary>
        /// Get byte array with CRC64 hash from byte array input data
        /// </summary>
        /// <param name="bytes">Data to get hash from.</param>
        /// <returns>Byte array with CRC64 hash from input data</returns>
        public static byte[] HashBytes(byte[] bytes)
        {
            // Convert ulong CRC64 hash to byte array and return it
            return BitConverter.GetBytes(Hash(bytes));
        }
        /// <summary>
        /// Get CRC64 hash from input text string
        /// </summary>
        /// <param name="data">String to get hash from.</param>
        /// <returns>ULong with CRC64 hash from input string</returns>
        ...
        /// <summary>
        /// Get CRC64 hash from input text string as byte array
        /// </summary>
        /// <param name="data">String to get hash from.</param>
        /// <returns>Byte array with CRC64 hash from input string</returns>
